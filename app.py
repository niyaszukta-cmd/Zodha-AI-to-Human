...
STYLE_PROMPTS = {
    "Academic": (
        "You are an expert academic editor. Rewrite so it reads as written by a real human scholar — NOT an AI. "
        "MANDATORY: (1) Vary sentence length dramatically — mix 4-8 word sentences with 25-40 word ones. "
        "(2) Use hedging: 'it appears that', 'the evidence suggests'. "
        "(3) Add discourse connectors: 'That said,', 'Interestingly,'. "
        "(4) Use rhetorical questions occasionally. (5) Break ALL passive voice. "
        "(6) Use 'we' and 'our' naturally. Preserve all meaning exactly."
    ),
    "Conversational": (
        "Rewrite to sound like a real human speaking naturally. "
        "MANDATORY: (1) Use contractions throughout: it's, don't, we've, can't, that's. "
        "(2) Alternate sentence lengths wildly — some 3-5 words, others 20-30 words. "
        "(3) Add asides: 'And honestly,', 'Here's the thing —'. "
        "(4) Use rhetorical questions. (5) Use first-person naturally. "
        "(6) Add transitions: 'On top of that,', 'And yet,'. Preserve all facts."
    ),
    "Professional": (
        "Rewrite as a senior consultant — authoritative yet natural, never robotic. "
        "MANDATORY: (1) Mix short punchy sentences with longer analytical ones. "
        "(2) Active voice for 85%+ sentences. (3) Add transitions: 'That said,', 'More importantly,'. "
        "(4) Use contractions: it's, we've, doesn't. (5) Vary paragraph length. Preserve all ideas."
    ),
    "Journalistic": (
        "Rewrite as a senior writer at The Economist. "
        "MANDATORY: (1) Open with a short punchy hook (5-10 words max). "
        "(2) Vary rhythm dramatically. (3) Active voice throughout. "
        "(4) Add journalist transitions: 'The result?', 'Consider this:'. "
        "(5) Use contractions. Create narrative momentum. Keep all facts."
    ),
    "Creative": (
        "Transform into vivid expressive prose. "
        "MANDATORY: (1) Striking sentence rhythm variation. "
        "(2) Weave in metaphor and sensory language. (3) Contractions and first-person voice. "
        "(4) Emotional resonance. (5) Vary paragraph lengths. Preserve all meaning."
    ),
}
...
INTENSITY_INSTRUCTIONS = {
    "Light":    "Lightly edit for naturalness. Fix robotic phrases, add 1-2 contractions and transitions. Keep 80% of original structure.",
    "Moderate": "Substantially rewrite. Restructure half the sentences. Vary length (shortest <8 words, longest >25). Add contractions and active voice.",
    "Deep":     "Completely transform into natural human writing. Every sentence restructured. Dramatic length variation. Contractions freely. Rhetorical questions. Active voice aggressively. Target Flesch >60. Preserve all meaning.",
}
...
2. Preserve 100% of original meaning and facts.
3. No bullet points unless original had them.
4. SENTENCE LENGTH VARIATION IS MANDATORY — both very short (<8 words) AND long (>25 words).
5. Use contractions naturally (it's, don't, we've, that's, they're).
6. Active voice for 80%+ sentences.
7. Include at least 3 transition phrases (However, That said, Interestingly, As a result, And yet).
8. Don't start every sentence with "The" or the same pattern.
...
<div class="hero-banner">
  <div class="hero-badge">v5.0 · Production</div>
